                    ...
                    <div class="px-2">
                        <form action="RegisterServlet" method="post" class="justify-content-center">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="jane.doe@example.com" name="email">
                            </div>
                            </div>
                                <div class="form-group">
                            	<h5 style="color:black;">Language</h5>
                                <label class="sr-only">Language</label>
                                <input type="text" class="form-control" placeholder="english" name="language">
                                
                            </div>
                            <button type="submit" class="btn btn-primary btn-lg">Submit</button>
                            <input type="button" class="btn btn-primary btn-lg" onClick="JavaScript:window.location='<%= myPage %>';"  value="Back">
